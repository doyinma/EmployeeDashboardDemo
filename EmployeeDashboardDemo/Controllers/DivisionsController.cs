...
namespace EmployeeDashboardDemo.Controllers
{
    public class DivisionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DateCreated")] Division division)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DateCreated")] Division division)
        {
            if (ModelState.IsValid)
            {
